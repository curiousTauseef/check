% $Id: trademark-macros.tex,v 1.15 2004/03/21 18:39:18 augart-oss Exp $
%
...
%% If you get any complaints about an unknown LaTeX macro for \htmlsym
%% then uncomment the alternative lines, or change this to use the
%% \htmlent{} command introduced in Hyperlatex 1.6.
\W \newcommand{\trademark}{\htmlsym{##8482}}
% \W \newcommand{\trademark}{\xml{sup}\xml{small}(TM)\xml{/small}\xml{/sup}}
\W \newcommand{\registeredTrademark}{\xml{sup}\xml{small}\htmlsym{reg}\xml{/small}\xml{/sup}}
