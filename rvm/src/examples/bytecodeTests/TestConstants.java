 ...
 */
//$Id: TestConstants.java,v 1.3 2003/10/30 19:07:12 augart-oss Exp $
/**
 * @author unascribed
 */
class TestConstants
   ...
   public static void runTest()
      {
      SystemOut.println("TestConstants");
   ...
   aconst()
      {
      Object x;
      x = null; SystemOut.print("\nwant: null\n got: "); SystemOut.println(x); // aconst_null
      }
   ...
   iconst()
      {
      int  x;
      x = -1; SystemOut.print("\nwant: -1\n got: "); SystemOut.println(x);  // iconst_m1
      x =  0; SystemOut.print("\nwant: 0\n got: ");  SystemOut.println(x);  // iconst_0
      x =  1; SystemOut.print("\nwant: 1\n got: ");  SystemOut.println(x);  // iconst_1
      x =  2; SystemOut.print("\nwant: 2\n got: ");  SystemOut.println(x);  // iconst_2
      x =  3; SystemOut.print("\nwant: 3\n got: ");  SystemOut.println(x);  // iconst_3
      x =  4; SystemOut.print("\nwant: 4\n got: ");  SystemOut.println(x);  // iconst_4
      x =  5; SystemOut.print("\nwant: 5\n got: ");  SystemOut.println(x);  // iconst_5
      }
   ...
   lconst()
      {
      long x;
      x =  0; SystemOut.print("\nwant: 0\n got: "); SystemOut.println(x);  // lconst_0
      x =  1; SystemOut.print("\nwant: 1\n got: "); SystemOut.println(x);  // lconst_1
      }
   ...
   fconst()
      {
      float x;
      x =  0; SystemOut.print("\nwant: 0.0\n got: "); SystemOut.println(x);  // fconst_0
      x =  1; SystemOut.print("\nwant: 1.0\n got: "); SystemOut.println(x);  // fconst_1
      x =  2; SystemOut.print("\nwant: 2.0\n got: "); SystemOut.println(x);  // fconst_2
      }
   ...
   dconst()
      {
      double x;
      x =  0; SystemOut.print("\nwant: 0.0\n got: "); SystemOut.println(x);  // dconst_0
      x =  1; SystemOut.print("\nwant: 1.0\n got: "); SystemOut.println(x);  // dconst_1
      }

   static void
   misc()
      {
      byte  x0 =                 127; SystemOut.print("\nwant: 127\n got: ");                  SystemOut.println(x0);           // bipush
            x0 =                -127; SystemOut.print("\nwant: -127\n got: ");                 SystemOut.println(x0);           // bipush

      short x1 =               32767; SystemOut.print("\nwant: 32767\n got: ");                SystemOut.println(x1);           // sipush
            x1 =              -32767; SystemOut.print("\nwant: -32767\n got: ");               SystemOut.println(x1);           // sipush

      int   x2 =          0x7fffffff; SystemOut.print("\nwant: 2147483647\n got: ");           SystemOut.println(x2);           // ldc
            x2 =          0x80000001; SystemOut.print("\nwant: -2147483647\n got: ");          SystemOut.println(x2);           // ldc

      long  x4 = 0x7fffffffffffffffL; SystemOut.print("\nwant: 9223372036854775807\n got: ");  SystemOut.println(x4);           // ldc2_w
            x4 = 0x8000000000000001L; SystemOut.print("\nwant: -9223372036854775807\n got: "); SystemOut.println(x4);           // ldc2_w
   
                                      SystemOut.print("\nwant: X98\n got: ");                  SystemOut.println(new TestConstants().s());  // ldc_w
      }
