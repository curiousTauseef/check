 ...
 */
//$Id: VM_JNIFunctions.java,v 1.68 2005/02/01 03:40:20 augart-oss Exp $
...
class VM_JNIFunctions implements VM_NativeBridge, 
  ...
  private static void SetShortArrayRegion(VM_JNIEnvironment env, int arrayJREF, int startIndex, 
    ...
    try {
      ...
      VM_Memory.memcopy(VM_Magic.objectAsAddress(destinationArray).add(startIndex << LOG_BYTES_IN_SHORT), 
