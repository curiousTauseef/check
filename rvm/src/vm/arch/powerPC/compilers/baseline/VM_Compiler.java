 ...
 */
//$Id: VM_Compiler.java,v 1.139 2005/02/25 18:46:53 dgrove-oss Exp $
...
//    pushFloat(F0);
  ...
  protected final void emit_i2f() {  
    if (VM.BuildFor64Addr) {
      ...
      asm.emitSTWoffset (T0, PROCESSOR_REGISTER, VM_Entrypoints.scratchStorageField.getOffset()); // MAGIC + X in scratch field
      fr.resolve(asm);
